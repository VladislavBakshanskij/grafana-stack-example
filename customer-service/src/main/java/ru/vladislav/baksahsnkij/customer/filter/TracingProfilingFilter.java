package ru.vladislav.baksahsnkij.customer.filter;
...
import ru.vladislav.baksahsnkij.customer.infra.ThrowingRunnable;

import java.io.IOException;
import java.util.Map;
import java.util.Optional;

import static ru.vladislav.baksahsnkij.customer.infra.ThrowingRunnable.throwingRunnable;
